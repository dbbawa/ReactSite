...
const Home = () => {
    return (
        <div className="index-page">
            <header>
                <h1 className="logo">SkiMastery</h1>
                <div className="hamburger" id="hamburger">&#9776;</div>
                <div className="tabs" id="nav-links">
                    <a href="index.html" className="tab">Home</a>
                    <a href="destinations.html" className="tab">Destinations</a>
                    <a href="basics.html" className="tab">Basics</a>
                    <a href="cost-gear.html" className="tab">Cost & Gear</a>
                    <a href="contact-us.html" className="tab">Contact Us</a>
                </div>
                ...
                <div className="content-wrapper">
                    ...
                    <div className="middle-section">
                        <div className="word-week">
                            ...
                            <p>Definition? Bumps that form on ski slopes when skiers carve turns and push snow into mounds.</p>
                            <p>How are they created? Created when skiers push snow out and away from them while turning.</p>
                            <p>How are they used? To create a challenge for skiers.</p>
                        </div>
                        <div className="article-box">
                            <a href="https://snowbrains.com/where-in-the-world-will-it-snow-this-week-these-are-the-top-5-forecasted-resorts-for-the-10-days-of-september-8-17-2024/">
            ...
            <footer>
                <div className="logo-bottom">
                    <img src={logoImage} className="logo-image" alt="SkiMastery Logo" />
                </div>
            </footer>
        </div>
    );
