    ...
    <main>
      ...
      <div className="grid-container">
        <div className="grid-item goggles-box">
          <img src="/images/goggles.jpg" alt="Ski Goggles" />
          <h3>Goggles</h3>
          <p>
        ...
        <div className="grid-item">
          <img src="/images/poles.jpg" alt="Ski Poles" />
          <h3>Poles</h3>
          <p>
        ...
        <div className="grid-item">
          <img src="/images/boots.jpg" alt="Ski Boots" />
          <h3>Boots</h3>
          <p>
        ...
        <div className="grid-item">
          <img src="/images/helmet.jpg" alt="Ski Helmet" />
          <h3>Helmet</h3>
          <p>
